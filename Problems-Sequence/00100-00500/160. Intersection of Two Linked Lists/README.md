...
// Imp link : https://leetcode.com/problems/intersection-of-two-linked-lists/discuss/1093014/C%2B%2B-Four-different-solutions
// Time: O(A + B)
// Space: O(1)
...
public:
    ListNode *getIntersectionNode(ListNode *headA, ListNode *headB) 
    {
        ...
        // Assign the dummy nodes 
        ListNode *a = headA;
        ListNode *b=  headB;
        
        // If a and b have different len , then we will stop the loop after 2n iter
        while(a != b)
        {
            // For the end of the first iteration 
            // We will reset the pointer to the head of oter ll
